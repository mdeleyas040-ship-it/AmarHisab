...
নতুন feature যোগ করলে FEATURE_RULES.md অবশ্যই follow করতে হবে। সাধারণ feature development `dev` branch-এ হবে; feature specification `docs/features/`-এ যোগ বা update করা বাধ্যতামূলক। Pull Request CI এই শর্ত যাচাই করবে।
