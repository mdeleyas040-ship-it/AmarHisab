...
class MealReminderReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val (title, message, notificationId) = when (mealType) {
            "breakfast" -> Triple("🍳 সকালের খাবারের সময়", "আজকের সুষম নাশতার তালিকা দেখতে চাপুন।", 3201)
            "lunch" -> Triple("🍱 দুপুরের খাবারের সময়", "আজকের সুষম দুপুরের খাবারের তালিকা দেখতে চাপুন।", 3202)
            else -> Triple("🍽️ রাতের খাবারের সময়", "আজকের সুষম রাতের খাবারের তালিকা দেখতে চাপুন।", 3203)
        }
